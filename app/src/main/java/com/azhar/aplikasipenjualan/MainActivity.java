...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aplikasi Penjualan Buku");
        ...
        btnproses = (Button)findViewById(R.id.beli);
        ...
        btnproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (total >= 200000){
                    txtbonus.setText("Bonus : Pensil");
                }
                else if (total >= 50000){
                    txtbonus.setText("Bonus : Penggaris");
                }
                else if (total >= 40000){
                    txtbonus.setText("Bonus : Penghapus");
                }
                else {
